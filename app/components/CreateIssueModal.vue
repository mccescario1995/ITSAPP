...
const form: any = reactive({
  issueDetails: "",
  actionPlan: "",
  issueTypeId: undefined as number | undefined,
  responsibleGroupId: undefined as number | undefined,
  responsibleEmpId: "",
...
const onSubmit = async () => {
  ...
  try {
    const data = {
      ...
      status: form.status,
      createdbyuserid: 250725606, //userProfile.value?.userid || "",
    };
...
<template>
  ...
  >
    <UButton label="Add Issue" variant="solid" class="px-7" />
    <template #body>
      <UForm
        :schema="schema"
        :state="form"
...
<template>
  ...
  >
    ...
    >
      ...
      <UFormField label="Responsible Group" name="responsibleGroupId" required>
        <USelect
          class="w-full"
          v-model="form.responsibleGroupId"
          :items="groups"
